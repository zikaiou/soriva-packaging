    ...
    <section className="mrb-section product-cross-links" aria-label="Related packaging links">
      <div className="container">
        ...
        <div className="product-cross-grid">
          ...
          <a href="/custom-packaging/">Explore Custom Packaging<span>Develop your structure and materials →</span></a>
          ...
          <a href="/contact/">Get A Quote<span>Start your packaging inquiry →</span></a>
        </div>
      </div>
    </section>
  );
